...
myplots <- 
  lapply(data2plot,FUN=function(lst) {
    # print(lst)
    dF=lst[[1]]
    errorvar=lst[[2]]
    # print(errorvar)
...
bestfitlines=lapply(X=data2plot,FUN=function(lst){
    # print(head(lst))
    mdldF=lst[[1]]
    errorvar=lst[[2]]
    # print(errorvar)
...
plot_grid(plotlist=myplots,ncol=2,labels=paste0('(',seq(1,16,1),')'))
